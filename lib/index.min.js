var chunkingStreams = require("chunking-streams"),
  ...
  FsDiffStream = function(e) {
    ...
    var f = function(e) {
        ...
        var t = h[s];
        t[e.id] ? t[e.id].length >= 1 && (2 == t[e.id].length && t[e.id].splice(0, 1), t[e.id].push(e), d(t[e.id])) : (t[e.id] = [e], e.fileName = s, e.targetChunkSize = r, n("uniqueChunk", null, {
          fileName: s,
      ...
      k = function() {
        if (u = null, !e.chunkCount) {
          r = e.chunkSize;
          var t = fs.statSync(s).size;
          a = h[s] && h[s].totalChunks ? h[s].totalChunks : void 0;
          var i = Math.floor(t / e.chunkSize) + 1;
          if (a && a != i) {
            a = i;
            var o = h[s].totalChunks;
        ...
        a = e.chunkCount;
        var t = fs.statSync(s).size;
        return r = Math.floor(t / e.chunkCount) + 1
      },
      m = function(e) {
