...
Operate on written data (suck), then read the result

Transform

_transform, _flush

In your implementation cide, it is very important to never call the methods described in API for Stream Consumers above. Otherwise, you can potentially cause adverse side effects in programs that consume your streaming interfaces.
